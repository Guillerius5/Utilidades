...
import es.fpsumma.dam2.utilidades.ui.screensAsignatura.ListadoAsignaturasScreen
...
fun AppNavHost(navController: NavHostController, tareasViewModel: TareasViewModel, asignaturasViewModel: AsignaturasViewModel) {
    NavHost(navController = navController, startDestination = Routes.HOME) {
        ...
        composable (Routes.LISTADO_ASIGNATURAS) { ListadoAsignaturasScreen(navController,asignaturasViewModel,Modifier
        ) }
    }
}